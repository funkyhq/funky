...
client to check the chat loop and how events render. The server tests drive the
HTTP surface (over the same fakes) through Starlette's test client: the four
